...
INSERT IGNORE INTO `users` VALUES
  ...
  (2, 0, 'login2', 'email2@test.com', 'password2', null,null,null),
  (3, 0, 'login3', 'email3@test.com', 'password3', null,null,null),
  (4, 0, 'login4', 'email4@test.com', 'password4', null,null,null),
  (5, 0, 'login5', 'email5@test.com', 'password5', null,null,null),
  (6, 0, 'login6', 'email6@test.com', 'password6', null,null,null),
